...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | SniperPOS is currently deployed for Philippine retail use. Keeping the
    | timezone configurable lets reports, greetings, receipt timestamps and
    | "today" boundaries follow the store's local clock instead of UTC.
    |
    */

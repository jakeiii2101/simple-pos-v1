...
>
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false"
        ...
        <div class="absolute inset-0 bg-[#08111F]/70 backdrop-blur-sm"></div>
    </div>

    <div x-show="show"
         class="relative mb-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_24px_70px_rgba(8,17,31,0.28)] transition-all sm:mx-auto sm:w-full {{ $maxWidth }}"
        ...
        <div class="h-1 bg-sniper-red"></div>
        {{ $slot }}
    </div>
</div>

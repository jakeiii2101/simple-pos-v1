<div class="sniper-page">
    ...
    <div class="sniper-table-wrap">
        ...
        <table class="sniper-table">
            <thead><tr><th>Product</th><th>SKU / Barcode</th><th>Category</th><th class="!text-right">Cost</th><th class="!text-right">Price</th><th class="!text-right">Stock</th><th>Status</th><th class="!text-right">Actions</th></tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td colspan="8" class="sniper-empty">No products yet. Add your first product to get started.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
